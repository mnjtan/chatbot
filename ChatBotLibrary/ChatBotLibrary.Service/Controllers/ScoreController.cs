...
namespace ChatBotLibrary.Service.Controllers
{
    ...
    public class ScoreController : Controller
    {
        ...
        public async Task<IEnumerable<ScoreModel>> GetAsync(string date, string season = "latest", string teams = "")
        {
            string options = "";
        ...
        public async Task<ScoreModel> GetAsync(string team, string season = "latest")
        {
        ...
        public async Task<ScoreModel> GetScoreAsync(string team1, string team2, string season = "latest")
        {
